...
class Settings(BaseSettings):
    ...
    max_planned_loss_usd: float = Field(default=0.10, gt=0, le=1.0)
    max_position_fraction: float = Field(default=0.25, gt=0, le=0.5)
    max_daily_loss_fraction: float = Field(default=0.02, gt=0, le=0.05)
    max_drawdown_fraction: float = Field(default=0.05, gt=0, le=0.20)
    max_orders_per_day: int = Field(default=2, ge=1, le=10)
    max_consecutive_losses: int = Field(default=2, ge=1, le=5)
